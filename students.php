...
<table height="100%" width="100%">
		...
		<tr height="60%">
			...
			<center><img src="img/vai.gif"></center><hr>
				<center><h2>Register Students</h2></center>
				<table width="30%" height="15%" align="center" border="4" bordercolor="maroon" rules="none" >
		<form method="post" action="fromallstudent.php">
			<tr>
				<td>View All Student Details<input type="Submit" value="Display"></td>
			</tr>
		</form>
	</table>
	...
	<table width="30%" height="15%" align="center" border="4" bordercolor="maroon" rules="none" >  
			...
			<tr>
				<td align="left" > Select Roll No:</td>
                                         
				<td >
									
					<form method="post" action="fromselectstudent.php">	
						<?php
