...
<head>
<title>Available Books LBMS</title>
</head>
...
<table height="100%" width="100%">
		...
		<tr height="60%">
			...
			<table width="30%" height="15%" align="center" border="4" bordercolor="black" rules="none" >
		<form method="post" action="fromallavailable2.php">
			<tr>
	...
	<table width="30%" height="15%" align="center" border="4" bordercolor="black" rules="none" >  
			...
			<tr>
				...
				<td >
					...
					<form method="post" action="fromselectavailable2.php">	
						<?php
