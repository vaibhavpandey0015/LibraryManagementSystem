...
?>
	...
	<table class="data-table"align="center" border="4" bordercolor="maroon" >
		<caption class="title">Displaying notification</caption>
		<thead>
			<tr>
				<th>Sr.no</th>
				<th>Notification</th>
	...
	<a href="home2.php"><b>Click here to return </b></a><br><br>
	<a href="add.php"><b>Click here to add notification </b></a><hr>
			</td>
		</tr>
